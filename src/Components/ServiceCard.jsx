...
const ServiceCard = ({imgURL: imageURL, label, subtext}) => {
  ...
  return (
    <div className='py-16 max-sm:py-8 px-10 max-sm:px-5 flex-1 shadow-3xl rounded-3xl max-xl:min-w-[300px]'>
        ...
        <h3 className='text-3xl font-palanquin font-bold my-5'>{label}</h3>
