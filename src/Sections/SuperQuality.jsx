...
const SuperQuality = () => {
  return (
    <section id="about-us" className="max-container flex max-lg:flex-col flex-row gap-6 justify-between">
      <div className="flex-1">
        <h2 className="text-4xl font-bold dark:text-white  font-palanquin lg:max-w-lg">We Provide You <span className="text-coral-red">Super Quality</span> Shoes</h2>
