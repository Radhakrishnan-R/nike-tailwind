...
const SpecialProducts = () => {
  return (
    <section className="flex max-lg:flex-col-reverse gap-8 justify-between items-center max-container">
      ...
      <div className="flex-1">
        <h2 className="text-4xl font-bold dark:text-white  font-palanquin lg:max-w-lg"><span className="text-coral-red">Special</span> offer</h2>
        ...
        <button className="border-2 py-3 dark:text-white  px-10 font-montserrat rounded-full font-medium">Learn more</button>
        </div>
