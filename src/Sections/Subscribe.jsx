...
const Subscribe = () => {
  return (
    <section className="flex flex-wrap gap-10 max-container justify-between items-center">
      <h2 className="text-4xl font-bold font-palanquin lg:max-w-lg">Sign Up for <span className="text-coral-red">Updates</span> & Newsletter</h2>
      ...
      <div className="sm:border-2 max-sm:flex-col gap-5 border-slate-300 flex-1 max-w-xl flex justify-between items-center max-h-fit py-3 px-5 rounded-full">
        <input className="max-sm:border-2 max-sm:w-full max-sm:border-slate-300 max-sm:py-5 max-sm:px-3 max-sm:flex-1 max-sm:rounded-full" placeholder="Subscribe@RKSport" />
